...
Start here if you want to use MotionForge as an open-source programmatic video layer.

- [Getting Started](getting-started.md): create a project, write `src/video.ts`, preview in Studio.
- [Authoring API](authoring-api.md): scene helpers, timing, media nodes, and the core escape hatch.
